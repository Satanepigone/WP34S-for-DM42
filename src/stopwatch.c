...
#ifdef DM42
#define STOPWATCH_RS KEY_RUN
#define STOPWATCH_EXIT KEY_EXIT
#define STOPWATCH_CLEAR KEY_BSP
#define STOPWATCH_EEX KEY_E
#define STOPWATCH_STORE KEY_ENTER
#define STOPWATCH_STORE_ROUND KEY_DOT
#define STOPWATCH_UP KEY_UP
#define STOPWATCH_DOWN KEY_DOWN
#define STOPWATCH_SHOW_MEMORY KEY_F5
#define STOPWATCH_RCL KEY_RCL
#define STOPWATCH_SIGMA_PLUS KEY_SIGMA
#define STOPWATCH_SIGMA_PLUS_STORE_ROUND KEY_ADD
#else
...
unsigned long getTicker() {
  long int f, t; // 24.8 is ffffff.ff
  t = get_rtc_ticks();
  f = ((t & 0xfffffff)*10)>>8; // tenths of a second, with lots of whole seconds before it;
  return f;
}
