...
#ifdef C_VERSION
#define VERS_DISPLAY "34C\006" VERSION_STRING "\222TC"
#else
...
#ifdef FOUR_K
#define RET_STACK_SIZE  1556
/* Combined return stack and program space reduced by two words for flag space 
(reducing by odd no.of words ruins alignment) */
#else
...
#if DM42
#define K_HEARTBEAT 98                  // Pseudo key, "pressed" every 100ms
#define K_RELEASE 99                    // Pseudo key, sent on key release
#else
